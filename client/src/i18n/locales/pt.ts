export default {
  ...
  // Modos de exibição
  standalone_name: "Independente (standalone)",
  standalone_description: "O aplicativo é executado em sua própria janela sem interface do navegador",
  minimal_ui_name: "Interface mínima (minimal-ui)",
  minimal_ui_description: "O aplicativo é executado em uma janela com controles mínimos do navegador",
  fullscreen_name: "Tela cheia (fullscreen)",
  fullscreen_description: "O aplicativo ocupa toda a tela, sem interface do navegador",
  browser_name: "Navegador (browser)",
  browser_description: "O aplicativo é executado em uma aba normal do navegador",
  ...
  status_browser_running: "O aplicativo está sendo executado no modo navegador padrão",
  ...
  install_disabled_browser_unsupported: "Seu navegador não suporta instalação de PWA",
  install_button_disabled: "Instalação não disponível",

  // Detector PWA
  detector_title: "Detector de Modo de Exibição PWA",
  detector_subtitle: "Esta ferramenta detecta como seu PWA está sendo executado atualmente",
  ...
  status_standalone_running: "O aplicativo já está sendo executado no modo independente",
  status_minimal_ui_prompt: "Você pode instalar este aplicativo para experimentar o modo independente completo",
  status_fullscreen_running: "O aplicativo já está sendo executado no modo de tela cheia",
  status_browser_installable: "Você pode instalar este aplicativo para experimentar o modo independente PWA",
  ...
  pwa_different_modes: "Os Aplicativos Web Progressivos (PWAs) podem ser executados em diferentes modos de exibição:",
