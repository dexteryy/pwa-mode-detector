export default {
  ...
  entry_subtitle:
    "Elige un modo de visualización para ver cómo las PWA funcionan de manera diferente",
  ...
  footer_text:
    "Demostración de Modos de Visualización PWA | Elige un modo para comenzar",

  // Modos de visualización
  standalone_name: "Independiente",
  standalone_description:
    "La aplicación se ejecuta en su propia ventana sin interfaz de usuario del navegador",
  minimal_ui_name: "Interfaz mínima",
  minimal_ui_description:
    "La aplicación se ejecuta en una ventana con controles mínimos del navegador",
  fullscreen_name: "Pantalla completa",
  fullscreen_description:
    "La aplicación ocupa toda la pantalla, sin interfaz de usuario del navegador",
  browser_name: "Navegador",
  browser_description:
    "La aplicación se ejecuta en una pestaña normal del navegador",
  ...
  status_browser_running:
    "La aplicación se está ejecutando en modo navegador estándar",
  ...
  install_disabled_browser_unsupported:
    "Tu navegador no admite la instalación de PWA, o ya has instalado esta aplicación",
  install_disabled_already_pwa:
    "Ya está ejecutándose en una ventana PWA, no se puede instalar de nuevo",
  install_disabled_already_installed:
    "La aplicación ya está instalada en este dispositivo, no se puede instalar de nuevo",
  install_button_disabled: "Instalación no disponible",

  // Detector PWA
  detector_title: "Detector de Modo de Visualización PWA",
  detector_subtitle:
    "Esta herramienta detecta cómo se está ejecutando actualmente tu PWA",
  ...
  status_standalone_running:
    "La aplicación ya se está ejecutando en modo independiente",
  status_minimal_ui_prompt:
    "Puedes instalar esta aplicación para experimentar el modo independiente completo",
  status_fullscreen_running:
    "La aplicación ya se está ejecutando en modo de pantalla completa",
  status_browser_installable:
    "Puedes instalar esta aplicación para experimentar el modo independiente PWA",
  status_browser_not_installable:
    "Tu navegador no admite la instalación de PWA",
  ...
  pwa_different_modes:
    "Las aplicaciones web progresivas (PWA) pueden ejecutarse en diferentes modos de visualización:",

  // Toast de actualización
  refreshing: "Actualizando...",
  refresh_process:
    "Comprobando el modo de visualización, el estado de instalación y actualizando la información del manifest",
