          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {displayModes.map(mode => (
              <Link key={mode.name} href={`/pwa/${mode.name}`}>
                <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow border-2 border-transparent hover:border-[#2563EB] cursor-pointer">
                  <div className="flex items-center mb-4">
                    <span className="material-icons text-4xl text-[#2563EB] mr-3">{mode.icon}</span>
