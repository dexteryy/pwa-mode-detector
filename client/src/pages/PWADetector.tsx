      ...
      <header className="bg-[#2563EB] text-white shadow-md">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link href="/">
              <div className="bg-white text-[#2563EB] px-3 py-1 rounded-full hover:bg-blue-50 transition-colors flex items-center cursor-pointer">
            ...
            <button 
              ...
              className={`bg-white text-[#2563EB] w-10 h-10 flex items-center justify-center rounded-full hover:bg-blue-50 transition-colors ${isRefreshing ? 'animate-spin' : ''}`} 
      ...
      {isInstallable && (
        <div className="fixed bottom-4 right-4">
          <button 
            ...
            className="bg-[#2563EB] text-white px-4 py-2 rounded-full shadow-lg hover:bg-[#1E40AF] flex items-center"
          >
